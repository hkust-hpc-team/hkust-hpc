...
Collect a set of representative real-world applications used by your users, test on these workloads.
This helps ensure that the system remains stable and performant for actual user workloads.
