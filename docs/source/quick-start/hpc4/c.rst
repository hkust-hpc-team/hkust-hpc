C/C++/Fortran Quick Start on HPC4
===============================================

Overview
--------
This guide briefly showcase the recommended workflow on HPC4 for compiling and running C/C++/Fortran programs.

.. note::
   TODO: Make below a warning note:
   You will need to use the SLURM scheduler for compiling, debugging and production runs. Please do not run jobs directly on the login nodes.
